...
class SendLocalFormControlle5 extends GetxController implements RequestInterface{
  ...
  SendLocalFormControlle5(this.polModel);
  ...
  sendDataToServer()async{
   // isloading(true);
    ...
    OfflineStorage(polModel.id).saveOneModel(OfflineSendedModel(id: 1, title: " ثبت تلفات", url: "https://api.smartmakran.ir/manualMonitoring/fatality", body: jsonEncode(body), createdAt: "", savedAt: "", sended: false, pound: polModel.id));

    //apiRequster.request("https://api.smartmakran.ir/manualMonitoring/fatality", ApiRequster.MHETOD_POST, 1,daynamicUrl: true, body: body);
  }
  @override
