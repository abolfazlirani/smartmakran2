...
class SendLocalFormController extends GetxController implements RequestInterface{
  ...
  sendDataToServer()async{
    ...
    OfflineStorage(polModel.id).saveOneModel(OfflineSendedModel(id: 1, title: " کیفیت آب به صورت دستی ", url: "https://api.smartmakran.ir/sensor", body: jsonEncode(body), createdAt: "", savedAt: "", sended: false, pound: polModel.id));
