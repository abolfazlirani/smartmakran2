                            ...
                            child:Column(
                              children: [
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Container(child: Image.asset("assets/images/ammonia.png",height: 3.h,),),
                                    Text("آمونیوم",style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.bold),)
                                  ],
                                ),
                                Expanded(child: Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  ...
                                  children: [
                                    Row(
                                      mainAxisSize: MainAxisSize.min,
                                      children: [
                                        Text("${model.ammonia}",style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold)),
                            ...
                            child:Column(
                              children: [
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Container(child: Image.asset("assets/images/vecteezy_no2-nitrogen-dioxide-line-icon_.png",height: 3.h,),),
                                    Text("نیتریت",style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.bold),)
                                  ],
                                ),
                                Expanded(child: Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  ...
                                  children: [
                                    Row(
                                      mainAxisSize: MainAxisSize.min,
                                      children: [
                                        Text("${model.nitrite}",style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold)),
                                        Text("",style: TextStyle(color: Colors.black,fontSize: 10,fontWeight: FontWeight.bold)),
                                      ],
                                    )
                                  ],
                            ...
                            child:Column(
                              children: [
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Container(child: Image.asset("assets/images/nitrate.png",height: 3.h,),),
                                    Text("نیترات",style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.bold),)
                                  ],
                                ),
                                Expanded(child: Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  ...
                                  children: [
                                    Row(
                                      mainAxisSize: MainAxisSize.min,
                                      children: [
                                        Text("${model.nitrate}",style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold)),
                                        Text("",style: TextStyle(color: Colors.black,fontSize: 10,fontWeight: FontWeight.bold)),
                                      ],
                                    )
                                  ],
